              ...
              <details className="cursor-pointer">
                ...
                <div className="mt-2 grid grid-cols-2 md:grid-cols-3 gap-2 text-xs">
                  {segment.words.map((word, wordIndex) => (
                    ...
                    >
                      <div className="font-medium text-neutral-200">{word.text}</div>
        ...
        <div className="mt-6 p-3 bg-[var(--color-bg-primary)] rounded-lg border border-neutral-700">
          <div className="grid grid-cols-2 gap-4 text-xs">
            <div>
              ...
              <span className="ml-2 font-medium text-neutral-200">{data.length}</span>
            </div>
            <div>
            ...
            <div>
              ...
              <span className="ml-2 font-medium text-emerald-400">
                {(data.reduce((acc, d) => acc + d.confidence, 0) / data.length * 100).toFixed(1)}%
              </span>
            </div>
            <div>
